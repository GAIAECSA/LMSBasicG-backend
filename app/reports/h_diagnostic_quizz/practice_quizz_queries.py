...
def get_practice_quizzes_headers(db: Session, course_id: int, business_id: int):
    """
...
def get_students_practice_quizzes_matrix(db: Session, course_id: int, business_id: int):
    """
