...
def create_forum_response(
    ...
    return forum_response_repo.create(
        db,
        data
    )
...
def get_all_by_enrollment(
    ...
    return forum_response_repo.get_all_by_enrollment(
        db,
        enrollment_id
    )
...
def get_all_by_lesson_block(
    ...
    return forum_response_repo.get_all_by_lesson_block(
        db,
        lesson_block_id
    )
...
def get_all_replies(
    ...
    return forum_response_repo.get_all_replies(
        db,
        forum_response_id
    )
...
def update_forum_response(
    ...
    forum_response = get_forum_response(
        db,
        forum_response_id
    )

    return forum_response_repo.update(
        db,
        forum_response,
        data
    )
...
def delete_forum_response(
    ...
    return forum_response_repo.delete(
        db,
        forum_response
    )